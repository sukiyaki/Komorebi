...
fun rememberSettingPreferences(repository: SettingsRepository): SettingPreferences {
    ...
    return SettingPreferences(
        ...
        liveEncoding = repository.liveEncoding.collectAsState(initial = "h264").value,
        liveQuality = repository.liveQuality.collectAsState(initial = "1080p").value,
        videoEncoding = repository.videoEncoding.collectAsState(initial = "h264").value,
        videoQuality = repository.videoQuality.collectAsState(initial = "1080p").value,
